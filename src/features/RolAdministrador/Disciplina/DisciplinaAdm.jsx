...
export default function DisciplinaAdm({ canchaId, onSelectDisciplina }) {
  ...
  useEffect(() => {
    const fetchDisciplinas = async () => {
      try {
        ...
        console.log("📦 Disciplinas cargadas (admin):", data);
        setDisciplinas(data);
      } catch (error) {
        console.error("❌ Error al cargar disciplinas (admin):", error);
      } finally {
        setLoading(false);
      }
    };

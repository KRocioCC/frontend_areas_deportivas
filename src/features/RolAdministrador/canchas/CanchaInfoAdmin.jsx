...
export default function CanchaInfoAdmin({ cancha }) {
  const infoItems = [
    {
      label: "Costo / hora",
      value: cancha.costoHora ? `Bs ${cancha.costoHora.toFixed(2)}` : "No definido",
      color: "text-[var(--accent1)]",
      icon: <FaMoneyBillWave />,
    },
    {
      label: "Capacidad",
      value: cancha.capacidad ? `${cancha.capacidad} pers.` : "No definido",

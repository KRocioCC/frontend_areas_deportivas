    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 md:p-6">
        <div className="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl">
          <GroupIcon className="text-gray-800 w-6 h-6" />
        </div>
        <div className="flex items-end justify-between mt-5">
          <div>
            <span className="text-sm text-gray-500">Clientes</span>
            <h4 className="mt-2 font-bold text-gray-800 text-lg">
              {totalClientes}
            </h4>
          </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 md:p-6">
        <div className="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl">
          <BoxIconLine className="text-gray-800 w-6 h-6" />
        </div>
        <div className="flex items-end justify-between mt-5">
          <div>
            <span className="text-sm text-gray-500">Reservas (Administrador {idAdministrador})</span>
            <h4 className="mt-2 font-bold text-gray-800 text-lg">
              {totalReservas}
            </h4>
          </div>

...
export default function ClienteForm({ initialData, onSave, onCancel }) {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      setForm({
        ...
        estadoCliente: initialData.estadoCliente ?? initialData.estado_cliente ?? "",
      });
    }
  }, [initialData]);
  ...
  function validate() {
    ...
    if (!form.estadoCliente.trim()) e.estadoCliente = "El estado del cliente es obligatorio";
    return e;
  }
  ...
  return (
    <form className="cliente-form" onSubmit={handleSubmit}>
      ...
      <div className="form-row">
        ...
        <input name="estadoCliente" value={form.estadoCliente} onChange={handleChange} />
        {errors.estadoCliente && <div className="form-error">{errors.estadoCliente}</div>}
      </div>

...
const AdministradorFormRegister = ({ onCancel, onSave }) => {
  const [formData, setFormData] = useState({
    ...
    email: '',
    nombre: '',
    apaterno: '', // Cambiar a minúsculas como funcionaba antes
    amaterno: '', // Cambiar a minúsculas como funcionaba antes
    telefono: '',
    fechaNacimiento: '',
    urlImagen: '',
    direccion: '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Usar el mismo formato que funcionaba antes
      const savePayload = {
        username: formData.username,
        password: formData.password,
        email: formData.email,
        nombre: formData.nombre,
        apaterno: formData.apaterno, // minúsculas
        amaterno: formData.amaterno, // minúsculas
      ...
      console.log('Payload con formato antiguo:', savePayload);

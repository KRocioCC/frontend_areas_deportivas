...
const RegisterAdministrador = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    Object.keys(formData).forEach(key => {
      if (key !== 'urlImagen' && key !== 'cargo' && key !== 'adminPassword') {
        allTouched[key] = true;
      }
    });
    ...
    try {
      ...
      await authService.registerAdministrador(datosEnvio);
      setShowSuccessModal(true);
      
    } catch (err) {
      console.error('Error completo:', err);
      alert(err.message || 'Error al registrar administrador. Verifica que todos los campos sean correctos.');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 border border-gray-700 rounded-xl p-6 max-w-md w-full text-center">
            ...
            <p className="text-gray-300 mb-6">
              Podrá loguearse cuando el sistema acepte su solicitud
            </p>
            <button
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-6">
            <div className="mb-4">
              ...
              <p className="text-gray-300 text-sm">
                Completa tus datos para solicitar ser administrador
              </p>
            </div>
            <button 
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl shadow-xl p-4 border border-gray-700">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Grid compacto para toda la información */}
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  {touched.direccion && errors.direccion && (
                    <div className="text-red-400 text-xs mb-1">{errors.direccion}</div>
                  )}
                  <input 
                    type="text" 
                    name="direccion" 
              ...
              <input type="hidden" name="adminPassword" value="passwordadmin" />
